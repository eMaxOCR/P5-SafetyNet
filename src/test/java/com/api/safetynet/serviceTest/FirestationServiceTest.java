...
public class FirestationServiceTest {
    ...
    void testGetFirestationNumberByAddressTest() {
        // Arrange
        String address = "test1";
        String expectedStationNumber = "1";

        when(fr.getFirestationNumberByAddress(address))
                .thenReturn(expectedStationNumber);

        // Act
        String result = fs.getFirestationNumberByAddress(address);
    ...
    void updateFirestationTest() { 
		// Arrange
        String addressToUpdate = "123 Main St";
        ...
        updateDetails.setAddress(addressToUpdate);
        updateDetails.setStation("3"); 

        when(fr.updateFirestation(addressToUpdate, stationToUpdate, updateDetails))
